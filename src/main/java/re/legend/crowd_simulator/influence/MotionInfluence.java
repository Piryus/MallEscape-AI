...
public class MotionInfluence extends Influence
{
	...
	/**TO DO?
	 * Constructor when an object influence translation and rotation
	 * 
	 * @param emitter
	 * @param simObject
	 * @param linearMotion
	...
	public MotionInfluence(AgentBody emitter, SimulationObject simObject, Vector2f linearMotion, float angularMotion)
	{
		//Test
		//assert (linearMotion != null);
		//assert (object != null);
